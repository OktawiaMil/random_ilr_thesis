---
title: "Results Summary: random ILR Augmentation Methods - Pseudo-count  1/max lib size"
...
knitr:
  opts_chunk:
    fig.path: _figures/summary_random_ilr_pc_max_lib_size/
    fig.width: 18
    fig.height: 13.5
---
...
graphics_abs <- here::here("content", "_figures", "summary_random_ilr_pc_max_lib_size")
...
create_summary_dashboard_random_ilr(
  ...
  id_prefix = "lasso_random_ilr_pc_mls"
)
...
save_metric_table_latex_random_ilr(
  ...
  aug_results = lasso_pc_max_lib_size,
  model_name = "lasso",
  output_dir = here::here("content", "_tables", "summary_random_ilr_pc_max_lib_size")
)
...
#| echo: false
#| results: asis
render_aug_imp_tabs(metric = "roc_auc", aug_results = lasso_pc_max_lib_size)
```
:::
...
render_aug_imp_tabs(metric = "misclassification_rate", aug_results = lasso_pc_max_lib_size)
...
create_summary_dashboard_random_ilr(
  ...
  id_prefix = "rf_random_ilr_pc_mls"
)
...
#| echo: false
#| results: asis
render_aug_imp_tabs(metric = "roc_auc", aug_results = random_forest_pc_max_lib_size)
```
:::
...
render_aug_imp_tabs(metric = "misclassification_rate", aug_results = random_forest_pc_max_lib_size)
...
create_summary_dashboard_random_ilr(
  ...
  id_prefix = "xgb_random_ilr_pc_mls"
)
...
#| echo: false
#| results: asis
render_aug_imp_tabs(metric = "roc_auc", aug_results = xgboost_pc_max_lib_size)
```
:::
...
render_aug_imp_tabs(metric = "misclassification_rate", aug_results = xgboost_pc_max_lib_size)
