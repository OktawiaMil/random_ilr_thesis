...
knitr:
  opts_chunk:
    fig.path: figures/summary_rodriguez/
    fig.width: 18
    fig.height: 13.5
---
...
graphics_abs <- here::here("quarto_scripts", "figures", "summary_rodriguez")
...
knitr::opts_chunk$set(fig.path = "figures/summary_rodriguez/")
...
output_dir <- here::here("quarto_scripts", "tables", "summary_rodriguez")
metric <- "roc_auc"
model_name <- "lasso"
